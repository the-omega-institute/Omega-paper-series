...
order: 61
description: "Tao Te Ching chapter 61 with source text and Omega chapter-level mapping."
...
第 61 章首先落在「治国之道」这条走廊上。它首先确认治理问题可被读成局部干预、失真边界与系统稳态的问题。 同时它还跨到 柔弱胜刚强，所以不是单线映射，而是一个重叠走廊。 当前最强的 Omega 方向集中在 fold-operator、rate-distortion-information-theory、golden-mean-shift。
...
- 本仓库原文文件：`texts/daodejing/chapter_61.txt`
