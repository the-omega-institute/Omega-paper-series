---
title: "72. 民不畏威，則大威至無狎其所居，無厭…"
subtitle: "Tao Te Ching Chapter Page"
order: 72
description: "Tao Te Ching chapter 72 with source text and Omega chapter-level mapping."
...
- 章号：第 72 章
- 章首：民不畏威，則大威至。無狎其所居，無厭其所生。
- 归属类别：治国之道
- 当前主方向：fold-operator, rate-distortion-information-theory

## 对应说明

第 72 章首先落在「治国之道」这条走廊上。它首先确认治理问题可被读成局部干预、失真边界与系统稳态的问题。 当前最强的 Omega 方向集中在 fold-operator、rate-distortion-information-theory。
...
- 本仓库原文文件：`texts/daodejing/chapter_72.txt`
