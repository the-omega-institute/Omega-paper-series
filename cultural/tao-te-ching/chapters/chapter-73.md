...
order: 73
description: "Tao Te Ching chapter 73 with source text and Omega chapter-level mapping."
...
- 章首：勇於敢則殺，
- 归属类别：柔弱胜刚强 / 玄同与整体统一
- 当前主方向：golden-mean-shift, fold-operator, rate-distortion-information-theory, modular-tower-inverse-limit, spectral-theory, dynamical-systems

## 对应说明

第 73 章首先落在「柔弱胜刚强」这条走廊上。它首先确认弱与柔不是消极退让，而是在受约束系统中更可持续的稳定策略。 同时它还跨到 玄同与整体统一，所以不是单线映射，而是一个重叠走廊。 当前最强的 Omega 方向集中在 golden-mean-shift、fold-operator、rate-distortion-information-theory、modular-tower-inverse-limit、spectral-theory、dynamical-systems。
...
- 本仓库原文文件：`texts/daodejing/chapter_73.txt`
