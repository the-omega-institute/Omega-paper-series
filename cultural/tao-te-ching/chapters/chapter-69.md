---
title: "69. 用兵有言﹕「吾不敢為主而為客，不敢…"
subtitle: "Tao Te Ching Chapter Page"
order: 69
description: "Tao Te Ching chapter 69 with source text and Omega chapter-level mapping."
...
- 章号：第 69 章
- 章首：用兵有言﹕「吾不敢為主而為客，不敢進寸而退尺。」是謂行無行，
- 归属类别：治国之道 / 柔弱胜刚强
- 当前主方向：fold-operator, rate-distortion-information-theory, golden-mean-shift

## 对应说明

第 69 章首先落在「治国之道」这条走廊上。它首先确认治理问题可被读成局部干预、失真边界与系统稳态的问题。 同时它还跨到 柔弱胜刚强，所以不是单线映射，而是一个重叠走廊。 当前最强的 Omega 方向集中在 fold-operator、rate-distortion-information-theory、golden-mean-shift。
...
- 本仓库原文文件：`texts/daodejing/chapter_69.txt`
