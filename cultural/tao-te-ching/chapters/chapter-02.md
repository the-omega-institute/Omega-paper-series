---
title: "02. 天下皆知美之為美，斯惡已皆知善之為…"
subtitle: "Tao Te Ching Chapter Page"
order: 2
description: "Tao Te Ching chapter 2 with source text and Omega chapter-level mapping."
...
- 章号：第 2 章
- 章首：天下皆知美之為美，斯惡已。皆知善之為善，斯不善已。故有無相生，難易相成，長短相較，高下相傾，音聲相和，前後相隨。
- 归属类别：对立互生与二元结构
- 当前主方向：golden-mean-shift, fold-operator

## 对应说明

第 2 章首先落在「对立互生与二元结构」这条走廊上。它首先确认 opposites 并非彼此孤立，而是在受约束的二元系统中互相条件、互相校正。 当前最强的 Omega 方向集中在 golden-mean-shift、fold-operator。
...
- 本仓库原文文件：`texts/daodejing/chapter_02.txt`
