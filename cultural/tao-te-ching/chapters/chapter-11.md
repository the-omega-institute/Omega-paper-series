---
title: "11. 三十輻共一轂，當其無，有車之用"
subtitle: "Tao Te Ching Chapter Page"
order: 11
description: "Tao Te Ching chapter 11 with source text and Omega chapter-level mapping."
...
- 章号：第 11 章
- 章首：三十輻共一轂，當其無，有車之用。
- 归属类别：对立互生与二元结构 / 虚空与容纳
- 当前主方向：golden-mean-shift, fold-operator, fiber-structure, zeckendorf-representation

## 对应说明

第 11 章首先落在「对立互生与二元结构」这条走廊上。它首先确认 opposites 并非彼此孤立，而是在受约束的二元系统中互相条件、互相校正。 同时它还跨到 虚空与容纳，所以不是单线映射，而是一个重叠走廊。 当前最强的 Omega 方向集中在 golden-mean-shift、fold-operator、fiber-structure、zeckendorf-representation。
...
- 本仓库原文文件：`texts/daodejing/chapter_11.txt`
