---
title: "32. 道常無名，樸雖小，天下莫能臣也侯王…"
subtitle: "Tao Te Ching Chapter Page"
order: 32
description: "Tao Te Ching chapter 32 with source text and Omega chapter-level mapping."
...
- 章号：第 32 章
- 章首：道常無名，樸雖小，天下莫能臣也。侯王若能守之，萬物將自賓。
- 归属类别：知足与限度 / 自然与朴素
- 当前主方向：golden-mean-shift, zeckendorf-representation, rate-distortion-information-theory

## 对应说明

第 32 章首先落在「知足与限度」这条走廊上。它首先确认 sufficiency 的核心不是贫乏，而是稀疏、不过载、不过界的最优结构。 同时它还跨到 自然与朴素，所以不是单线映射，而是一个重叠走廊。 当前最强的 Omega 方向集中在 golden-mean-shift、zeckendorf-representation、rate-distortion-information-theory。
...
- 本仓库原文文件：`texts/daodejing/chapter_32.txt`
