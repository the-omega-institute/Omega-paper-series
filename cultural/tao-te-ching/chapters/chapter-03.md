---
title: "03. 不尚賢，使民不爭，不貴難得之貨，使…"
subtitle: "Tao Te Ching Chapter Page"
order: 3
description: "Tao Te Ching chapter 3 with source text and Omega chapter-level mapping."
...
- 章号：第 3 章
- 章首：不尚賢，使民不爭；不貴難得之貨，使民不為盜；不見可欲，使民心不亂。
- 归属类别：无为与自然秩序 / 治国之道
- 当前主方向：fold-operator, dynamical-systems, rate-distortion-information-theory

## 对应说明

第 3 章首先落在「无为与自然秩序」这条走廊上。它首先确认秩序不是靠外加命令维持，而是由 constraint 自发收敛出的稳定结果。 同时它还跨到 治国之道，所以不是单线映射，而是一个重叠走廊。 当前最强的 Omega 方向集中在 fold-operator、dynamical-systems、rate-distortion-information-theory。
...
- 本仓库原文文件：`texts/daodejing/chapter_03.txt`
