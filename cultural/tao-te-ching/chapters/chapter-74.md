---
title: "74. 民不畏死，奈何以死懼之？若使民常畏…"
subtitle: "Tao Te Ching Chapter Page"
order: 74
description: "Tao Te Ching chapter 74 with source text and Omega chapter-level mapping."
...
- 章号：第 74 章
- 章首：民不畏死，奈何以死懼之？若使民常畏死，而為奇者，吾得執而殺之，孰敢？
- 归属类别：治国之道
- 当前主方向：fold-operator, rate-distortion-information-theory

## 对应说明

第 74 章首先落在「治国之道」这条走廊上。它首先确认治理问题可被读成局部干预、失真边界与系统稳态的问题。 当前最强的 Omega 方向集中在 fold-operator、rate-distortion-information-theory。
...
- 本仓库原文文件：`texts/daodejing/chapter_74.txt`
