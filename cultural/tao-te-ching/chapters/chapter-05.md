---
title: "05. 天地不仁，以萬物為芻狗，"
subtitle: "Tao Te Ching Chapter Page"
order: 5
description: "Tao Te Ching chapter 5 with source text and Omega chapter-level mapping."
...
第 5 章首先落在「对立互生与二元结构」这条走廊上。它首先确认 opposites 并非彼此孤立，而是在受约束的二元系统中互相条件、互相校正。 当前最强的 Omega 方向集中在 golden-mean-shift、fold-operator。
...
- 本仓库原文文件：`texts/daodejing/chapter_05.txt`
